...
var startAnimate = function(id, wordList, delay) {
	window.setInterval(doAnimate, delay, id, wordList)
}
var doAnimate = function(id, wordList) {
	animateCounter = animateCounter++ % wordList.length;
	$(id).html(wordList[animateCounter]);
}
